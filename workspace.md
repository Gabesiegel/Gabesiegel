...
_  Output structure: Image abbrevivation - date - Image result. Example [CXR - 4/26/2024 - No evidence of Pneaumonia]
...
**Pertinent Chart Review**
    - Include pertinent chart review results releated to the current condition. Organize by note type (triage note, admission note, discharge note, ED note, PCP note, Subspeciality clinic note)
